...
public:
    ...
    void addShape(sf::Shape* p)
    {
        ...
        p->setPosition(mField.getPosition() + sf::Vector2f(getRandomFloat(min.x, max.x), getRandomFloat(min.y, max.y)));
...
public:
    ...
    void execute() override
    {
        ...
        sf::Shape* ps;
        if (r == 0)
            ps = new sf::RectangleShape(sf::Vector2f(getRandomFloat(mMinSize, mMaxSize), getRandomFloat(mMinSize, mMaxSize)));
        else if (r == 1)
...
int main()
{
    ...
    control.addButton(new Button(window, sf::FloatRect{40,80,240,40}, font, 20, sf::String("Rotate First")), new RotateCommand(pool,0,30));
    control.addButton(new Button(window, sf::FloatRect{40,140,240,40}, font, 20, sf::String("Rotate Second")), new RotateCommand(pool,1,45));
    control.addButton(new Button(window, sf::FloatRect{40,200,240,40}, font, 20, sf::String("One Color")), new RandomColorCommand(pool,3));
    control.addButton(new Button(window, sf::FloatRect{40,260,240,40}, font, 20, sf::String("Rand Positions")), new RandomAllPositionsCommand(pool));
    control.addButton(new Button(window, sf::FloatRect{40,320,240,40}, font, 20, sf::String("New Shape")), new AddNewRandomShape(pool,10,150));
    control.addButton(new Button(window, sf::FloatRect{40,380,240,40}, font, 20, sf::String("Rand Colors")), new RandomAllColorsCommand(pool));
